...
class PasswordGenerator:
    ...
    def generate_password(
        ...
        """Generate a password with guaranteed inclusion of selected character types."""
        ...
        # First pass guarantees every selected character class appears at least once.
    ...
    def _secure_shuffle(self, items: list[str]) -> None:
        """In-place Fisher-Yates shuffle driven by cryptographic randomness."""
